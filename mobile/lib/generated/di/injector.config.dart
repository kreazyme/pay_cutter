...
import 'package:pay_cutter/data/datasource/local/user_local.datasource.dart'
    as _i13;
import 'package:pay_cutter/data/datasource/remote/chat.datasource.dart' as _i4;
...
import 'package:pay_cutter/data/repository/chat_repo.dart' as _i5;
...
import 'package:pay_cutter/generated/di/modules/local_modules.dart' as _i16;
...
Future<_i1.GetIt> initGetIt(
  ...
  gh.lazySingleton<_i4.ChatDataSource>(() => _i4.ChatDataSource());
  gh.lazySingleton<_i5.ChatRepository>(
      () => _i5.ChatRepository(chatDataSource: gh<_i4.ChatDataSource>()));
  ...
  gh.lazySingleton<_i10.GroupDataSource>(() => _i10.GroupDataSource());
  ...
  gh.lazySingleton<_i14.UserRepo>(
      () => _i14.UserRepo(userLocalDatasource: gh<_i13.UserLocalDatasource>()));
