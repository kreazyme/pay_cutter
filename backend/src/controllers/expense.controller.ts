...
export class ExpenseController {
  ...
  public findExpense = async (req: RequestWithUser, res: Response, next: NextFunction): Promise<void> => {
    try {
  ...
  public getExpensesByGroup = async (req: RequestWithUser, res: Response, next: NextFunction): Promise<void> => {
    try {
